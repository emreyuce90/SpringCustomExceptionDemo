...
import com.emre.springcustomexceptions.entities.Departmant;
...
public class EmployeeService implements IEmployeeService {
    ...
    @Override
    public Response<EmployeeDto> saveEmployee(EmployeeUIDto employeeUIDto) {
        Employee employee = new Employee();
        BeanUtils.copyProperties(employeeUIDto, employee);
        employeeRepository.save(employee);
        return new Response<EmployeeDto>().success(new EmployeeDto());
    }
}